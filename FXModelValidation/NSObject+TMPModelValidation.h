...
*/
@protocol TMPModelValidation <TMPModel>
@required
/**
...
*    3) a block]
*    4) an instance of an class that extending the TMPModelValidator
*    5) a class that extending the TMPModelValidator
...
/**
* Attach TMPModelValidation protocol implementation to class.
*/
+(BOOL)validationInit;

/**
* Attach TMPModelValidation protocol implementation to instance
*/
-(BOOL)validationInit;

/**
* Attach TMPModelValidation protocol implementation to class and try to add an implementation for rules method. The default class implementation of rules will be used if there is any.
*/
+(BOOL)validationInitWithRules:(NSArray *)rules;

/**
* Attach TMPModelValidation protocol implementation to instance and try to add an implementation for rules method. The default class implementation of rules will be used if there is any.
*/
-(BOOL)validationInitWithRules:(NSArray *)rules;

/**
* Attach TMPModelValidation protocol implementation to class and force to use an implementation for new implementation of rules method. The default class implementation of rules will be ignored.
*/
