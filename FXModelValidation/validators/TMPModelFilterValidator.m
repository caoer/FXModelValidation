...
#import "TMPModelFilterValidator.h"

NSString *const FXFormFilterValidatorMethodSignature = @"%@:params:";

@interface TMPModelFilterValidator ()
@property(nonatomic, strong) NSDictionary *params;
@end

@implementation TMPModelFilterValidator
...
#pragma clang diagnostic pop
			...
			@throw [NSException exceptionWithName:@"TMPModelFilterValidator" reason:@"The 'filter' property is incorrect." userInfo:nil];
		}
