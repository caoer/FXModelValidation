...
/**
* TMPModelFilterValidator converts the attribute value according to a filter.
*
* TMPModelFilterValidator is actually not a validator but a data processor.
...
*/
@interface TMPModelFilterValidator : TMPModelValidator
/**
