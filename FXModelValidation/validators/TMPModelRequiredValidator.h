...
/**
* TMPModelRequiredValidator validates that the specified attribute is not empty or have required value.
*/
@interface TMPModelRequiredValidator : TMPModelValidator
