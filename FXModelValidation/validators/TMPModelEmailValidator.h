...
/**
* TMPModelEmailValidator validates that the attribute value is a valid email address.
*/
@interface TMPModelEmailValidator : TMPModelValidator
/**
...
* TMPModelUrlValidator (@see TMPModelUrlValidator:encodeIDN) is used for IDN.
*/
